                ...
                <div className="flex justify-between w-full items-center">
                    ...
                    <dialog id="rules" className="modal">
                        <div className="modal-box">
                            ...
                            <p className="py-4">
                                - Tebak kata berdasarkan hint yang muncul <br />
                                - Setiap tebakan salah akan mengurangi 1 nyawa{' '}
                                <br />- Player akan diberi 3 nyawa untuk setiap
                                match <br />
                                - Pemenang ditentukan berdasarkan player yang
                                bertahan terakhir <br />- Tebak kata berdasarkan
                                kata yang muncul
                            </p>
